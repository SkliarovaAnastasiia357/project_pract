...
Летняя проектная практика продолжает разработку Teamnova, начатую командой «Чамбакет» в рамках проектного практикума. Это следующая итерация существующего проекта и репозитория, а не новый или сторонний проект.
