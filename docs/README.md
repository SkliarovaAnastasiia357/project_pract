...
5. Заявки: участник откликается на проект, владелец просматривает входящие заявки, принимает/отклоняет их, а принятые кандидаты отображаются как команда проекта;
6. Хостинг: Публичная ссылка, доступная с любого браузера.
