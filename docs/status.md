...
Финальный MVP Teamnova продолжает развиваться командой «Чамбакет» после проектного практикума; новый или сторонний проект для летней практики не создавался. Итерация летней практики добавляет владельцу проекта проактивный подбор команды по стеку и ролям без изменения backend API.
