...
const featureList = [
  "Создайте профиль с описанием и навыками, чтобы вас находили по реальному опыту.",
  "Публикуйте проекты с нужным стеком и ролями для будущей команды.",
  "Отправляйте заявки, принимайте участников и собирайте команду в одном месте.",
];
